  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        ...
        // ✅ 적정 조도 판별
        console.log();
        if (crop.adcMin !== undefined && crop.adcMax !== undefined) {
          const allInRange = result.every(
            (d) => d.조도 >= crop.adcMin && d.조도 <= crop.adcMax
          );
    ...
    fetchHistory();
  }, [interval, crop.adcMin, crop.adcMax]);
        ...
        {isTemperatureOk ? (
          <>
            ...
            <div className={styles.statusGood}>
              <span style={{ color: "green" }}>✅ 조도가</span>
          ...
          <>
            ...
            <div className={styles.statusGood}>
              <span style={{ color: "red" }}>⚠️ 조도가</span>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            ...
            <ReferenceArea
              ...
              fillOpacity={0.2}
              label={{
                value: `${crop.crop} 적정 조도 : (${crop.adcMin} ~ ${crop.adcMax} ADC) `,
